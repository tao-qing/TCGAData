#!/usr/bin/env python
"""
This software was modified based on the birdseed2VCF (https://github.com/ding-lab/birdseed2vcf), which was developed by Prof. Li Ding's lab
Only used for annotation of TCGA tangent results.
